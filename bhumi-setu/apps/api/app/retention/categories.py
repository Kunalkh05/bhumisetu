...
CATEGORY_MAP: dict[tuple[str, str], str | Discriminated | Reference] = {
    ...
    ("data_subject_request", "disposal_outcome"): AUDIT_EVENT,
    ("data_subject_request", "disposal_reasons"): AUDIT_EVENT,
    ("data_subject_request", "deciding_officer_id"): AUDIT_EVENT,
